...
namespace MangaNPK.Data
{
    public static class MangaDbSeeder
    {
        public static void Seed(MangaDbContext context)
        {
            ...
            // Seed Manga, Chapters, and Pages if empty
            if (!context.Mangas.Any())
            {
                ...
                // --- 1. ONE PUNCH MAN (Manga - Nhật Bản) ---
                var opm = new Manga
                {
                    Title = "One Punch Man",
                ...
                // --- 2. SOLO LEVELING (Manhwa - Hàn Quốc) ---
                var sl = new Manga
                {
                    Title = "Solo Leveling",
                ...
                // --- 3. MARTIAL PEAK (Manhua - Trung Quốc) ---
                var mp = new Manga
                {
            ...
            // Ensure demographic and format are seeded correctly for existing database records
