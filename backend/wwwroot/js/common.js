      ...
      <div style="display: flex; align-items: center; gap: 12px; position: relative;">
        ...
        <div id="header-user-dropdown" style="display: none; position: absolute; top: 48px; right: 0; width: 220px; background-color: var(--bg-card); border: 1px solid var(--border-subtle); border-radius: 8px; box-shadow: var(--shadow-lg); z-index: 1000; padding: 12px; overflow: hidden; flex-direction: column; gap: 10px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 2px;">
            <a href="/profile" class="dropdown-item-link" style="display: flex; align-items: center; gap: 10px; padding: 6px 10px; border-radius: 6px; font-size: 0.85rem; color: var(--text-main); text-decoration: none;"><i data-lucide="user" style="width: 15px; height: 15px; color: var(--text-muted);"></i><span>${t('user.profile', 'H\u1ed3 s\u01a1 c\u1ee7a t\u00f4i')}</span></a>
            ...
            <a href="/my-reports" class="dropdown-item-link" style="display: flex; align-items: center; gap: 10px; padding: 6px 10px; border-radius: 6px; font-size: 0.85rem; color: var(--text-main); text-decoration: none;"><i data-lucide="flag" style="width: 15px; height: 15px; color: var(--text-muted);"></i><span>${t('user.myReports', 'B\u00e1o c\u00e1o c\u1ee7a t\u00f4i')}</span></a>
